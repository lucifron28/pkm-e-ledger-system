...
| Security | Bcrypt 72-byte limit & max string lengths | High | `lib/auth/password.ts`, `lib/actions/register.ts`, `lib/actions/password.ts` | `tests/core/rbac.test.ts` (bcrypt salt rounds & hashing complexity unit tests) | Remediated |
