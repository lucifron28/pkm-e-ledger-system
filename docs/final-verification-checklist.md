...
- **Execution Timestamp**: `2026-08-08T14:00:00+08:00`
...
- `npm run test:core` — **9 files, 93 cases, 93 pass / 0 fail / 0 skip** (`attachments.test.ts`, `audit.test.ts`, `financial.test.ts`, `modal-focus.test.ts`, `money.test.ts`, `password.test.ts`, `rbac.test.ts`, `reports.test.ts`, `storage-reconciliation.test.ts`, `transfers.test.ts`).
...
- `npm run test` (full suite) — **15 files, 135 cases, 135 pass / 0 fail / 0 skip**.
...
- [x] `npm run test:core` passes 93 core unit tests across 9 test files (`attachments.test.ts`, `audit.test.ts`, `financial.test.ts`, `modal-focus.test.ts`, `money.test.ts`, `password.test.ts`, `rbac.test.ts`, `reports.test.ts`, `storage-reconciliation.test.ts`, `transfers.test.ts`).
...
- [x] `npm run test` passes full test suite (135/135 passing across 15 test files; 0 fail, 0 skip).
